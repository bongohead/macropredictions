...
local({
	...
	cme_raw_data = list_rbind(map(df_to_list(cme_search_space), function(var) {
		...
		# Note: use priorSettle instead of last to get previous day's close
...
# 	"DROP TABLE interest_rate_model_futures_values"
# ))
#
# DBI::dbExecute(pg, sql(
# 	"CREATE TABLE interest_rate_model_futures_values (
# 		scrape_source VARCHAR(50) NOT NULL,
...
# 		CONSTRAINT interest_rate_model_futures_values_pk PRIMARY KEY (scrape_source, varname, expdate, tenor, vdate)
# 	)"
# ))
